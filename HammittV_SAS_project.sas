...
DATE: Monday, January 12, 2015     TIME: 3:43:00 PM
PROJECT: HammittV_SAS_project_01.12.15
PROJECT PATH: P:\QAC\qac200\students\vhammitt\Assignments\HammittV_SAS_project_01.12.15.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\vhammitt\Assignments\HammittV_SAS_project_01.12.15.egp';
%LET _CLIENTPROJECTNAME='HammittV_SAS_project_01.12.15.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:53 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:54 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:55 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:56 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:57 PM
...
/*   START OF NODE: Categorize   */
%LET _CLIENTTASKLABEL='Categorize';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\vhammitt\Assignments\HammittV_SAS_project_01.12.15.egp';
%LET _CLIENTPROJECTNAME='HammittV_SAS_project_01.12.15.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(MYDATA.MARRY_ED_CAT);

PROC SQL;
   CREATE TABLE MYDATA.MARRY_ED_CAT(label="MARRY_ED_CAT") AS 
   SELECT t1.DUPERSID, 
          t1.AGE12X, 
          t1.SEX, 
          t1.REGION12, 
          ...
          /* EDU_CAT */
            (CASE  
               ...
               THEN 5
               ELSE 6
            END) LABEL="Education recode categorical" AS EDU_CAT
      FROM MYDATA.MEPS_FULLYR_2012_FILTER_MANAGED t1;
QUIT;
...
/*   START OF NODE: Table Analysis of MARRY and EDU categories   */
%LET _CLIENTTASKLABEL='Table Analysis of MARRY and EDU categories';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\vhammitt\Assignments\HammittV_SAS_project_01.12.15.egp';
%LET _CLIENTPROJECTNAME='HammittV_SAS_project_01.12.15.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:57 PM
   By task: Table Analysis of MARRY and EDU categories

   Input Data: Local:MYDATA.MARRY_ED_CAT
   Server:  Local
   ------------------------------------------------------------------- */

%_eg_conditional_dropds(WORK.SORTTempTableSorted);
/* -------------------------------------------------------------------
   Sort data set Local:MYDATA.MARRY_ED_CAT
   ------------------------------------------------------------------- */

PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.MARRY_CAT, T.MARRY, T.EDU, T.EDU_CAT
	FROM MYDATA.MARRY_ED_CAT(FIRSTOBS=1 ) as T
;
QUIT;
TITLE;
TITLE1 "Table Analysis of categorization";
FOOTNOTE;
FOOTNOTE1 "Generated by the SAS System (&_SASSERVERNAME, &SYSSCPL) on %TRIM(%QSYSFUNC(DATE(), NLDATE20.)) at %TRIM(%SYSFUNC(TIME(), TIMEAMPM12.)) by Victoria Hammitt";
PROC FREQ DATA = WORK.SORTTempTableSorted
	ORDER=INTERNAL
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:36:59 PM
...
/*   START OF NODE: Distribution Analysis for Concern Filter   */
%LET _CLIENTTASKLABEL='Distribution Analysis for Concern Filter';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\vhammitt\Assignments\HammittV_SAS_project_01.12.15.egp';
%LET _CLIENTPROJECTNAME='HammittV_SAS_project_01.12.15.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:37:00 PM
   By task: Distribution Analysis for Concern Filter

   Input Data: Local:MYDATA.CONCERN_FILTER
   Server:  Local
   ------------------------------------------------------------------- */
...
OPTIONS DEV=PNG;
/* -------------------------------------------------------------------
   Sort data set Local:MYDATA.CONCERN_FILTER
   ------------------------------------------------------------------- */

PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.AGG_CONCERN
	FROM MYDATA.CONCERN_FILTER as T
;
QUIT;
TITLE;
TITLE1 "Distribution analysis of: AGG_CONCERN";
FOOTNOTE;
FOOTNOTE1 "Generated by the SAS System (&_SASSERVERNAME, &SYSSCPL) on %TRIM(%QSYSFUNC(DATE(), NLDATE20.)) at %TRIM(%SYSFUNC(TIME(), TIMEAMPM12.))";
	ODS EXCLUDE EXTREMEOBS MODES MOMENTS QUANTILES;
...
/*   START OF NODE: List Data for Concern Filter   */
%LET _CLIENTTASKLABEL='List Data for Concern Filter';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\vhammitt\Assignments\HammittV_SAS_project_01.12.15.egp';
%LET _CLIENTPROJECTNAME='HammittV_SAS_project_01.12.15.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 3:37:00 PM
   By task: List Data for Concern Filter
...
PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.AGG_CONCERN, T.ROUT_CARE_R, T.IMMED_CARE_R, T.NO_NEED_INS_R, T.OVER_NO_HELP_R, T.RISK_R, T.TOT_EXP_CAT, T.MED_OFF_VIS, T.EZ_MED_CARE, T.GEN_HEALTH
	FROM MYDATA.CONCERN_FILTER as T
;
QUIT;
TITLE;
...
PROC PRINT DATA=WORK.SORTTempTableSorted
	...
	LABEL
	;
	VAR AGG_CONCERN ROUT_CARE_R IMMED_CARE_R NO_NEED_INS_R OVER_NO_HELP_R RISK_R TOT_EXP_CAT MED_OFF_VIS EZ_MED_CARE GEN_HEALTH;
RUN;
/* -------------------------------------------------------------------
   End of task code.
   ------------------------------------------------------------------- */
